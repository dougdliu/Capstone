...
{
    public partial class ManualZoomG : Form
    {
        public Gain_Results ownerGraph1; //connects to Gain_Results.cs, for "Manual Zoom" button
        ...
        public void Gain_Results_Shown()
        {
            ...
            textBox4.Text = ownerGraph1.Gain_Chart.ChartAreas[0].AxisY.ScaleView.ViewMinimum.ToString();
            textBox3.Text = ownerGraph1.Gain_Chart.ChartAreas[0].AxisY.ScaleView.ViewMaximum.ToString();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                zoomAxis(ownerGraph1.Gain_Chart.ChartAreas[0].AxisX, Convert.ToDouble(textBox2.Text), Convert.ToDouble(textBox1.Text));
                zoomAxis(ownerGraph1.Gain_Chart.ChartAreas[0].AxisY, Convert.ToDouble(textBox4.Text), Convert.ToDouble(textBox3.Text));
